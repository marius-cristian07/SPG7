...
During Sprint planning, the team chose to start work on setup tasks and workflow workflow preparation, and left coding for the next sprints. The main focus was on app architecture and Scrum process. 
...
Based on this feedback, the team decided to improve the backlog structure and use Jira more actively in the following sprints. Evidence of Sprint 0 Planning and Review can be found in Figure~\ref{fig:sprint0-planning-review}.
...
Sprint 2 Retrospective evidence can be found in Figure~\ref{fig:sprint2-retrospective}.
