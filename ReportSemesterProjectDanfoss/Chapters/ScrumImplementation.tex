...
When we set up the project in Sprint 0 we considered both Trello and Jira~\cite{jira}. Even though Trello was quite easy to understand and had a simple layout we thought Jira seemed better suited for a software development project because it offered more ways to organize our tasks and track the progress. One more reason is that we preferred Jira's interface because it is a very feature rich tool and the benefit of using it was that it is very used in the industry so getting some experience with it felt pretty nice for future projects, therefore it was an easy choice.
