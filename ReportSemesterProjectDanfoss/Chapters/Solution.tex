...
For the user interface we chose Avalonia~\cite{avalonia} because it fits the MVVM~\cite{avaloniamvvm}~\cite{mvvmtoolkit} design pattern perfectly and to create the graphs we used the LiveCharts2~\cite{livecharts}~\cite{skiasharp} library since a large part of the project involved presenting optimization results in a way that was easy for users to understand.
